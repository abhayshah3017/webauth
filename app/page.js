...
export default function Home() {
  ...
  return (
    <div className="min-w-screen min-h-screen bg-gray-900 flex mx-auto p-10 justify-center align-middle">
          ...
          <div className="md:flex w-full">
            ...
            <div className="w-full py-10 px-5 md:px-10">
              ...
              {!tokenExists ? (
                <div>
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-12">
                      <label htmlFor="token" className=" font-semibold px-1">
                        Secret token
                      </label>
                      <div className="flex">
                ...
                <div className="w-full bg-gradient-to-r from-indigo-600 to-pink-500 rounded-lg p-10">
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3">
                      <button
                        className="block w-fit mx-auto hover:bg-white hover:text-black mt-2 text-white rounded-lg p-2"
                        onClick={() => refreshCode()}
                      >
                        REFRESH CODE
                      </button>
